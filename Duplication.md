...
Reusing code created for the [bmesh.ops wiki page](https://github.com/zeffii/BlenderPythonRecipes/wiki/bmesh_ops), minus some comments. Read that link if you encounter problems.
